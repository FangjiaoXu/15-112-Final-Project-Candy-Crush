...
class game:
    ...
    def makemove(self,x1,y1,x2,y2):
        if (x1==x2 and abs(y1-y2)==1) or (y1==y2 and abs(x1-x2)==1):
            ...
            #count is the number of candies match
            count=self.rowmatch(x1,y1)+self.rowmatch(x2,y2)+self.colmatch(x1,y1)+self.colmatch(x2,y2)
    ...
    def colmatch(self,x,y):
        ...
        if x==1:
            ...
            if self.listnum[x][y]==self.listnum[x+1][y] and self.listnum[x][y]==self.listnum[x+2][y]:
                ...
                self.ellist.append(n+8)
                self.ellist.append(n+16)
            if self.listnum[x][y]==self.listnum[x+1][y] and self.listnum[x][y]==self.listnum[x-1][y]:
                count=3
                n=8*x+y
                self.ellist.append(n)
                self.ellist.append(n+8)
